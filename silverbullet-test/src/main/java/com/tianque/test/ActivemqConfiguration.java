...
public class ActivemqConfiguration {
    ...
    public ActiveMQConnectionFactory activeMQConnectionFactory (@Value("${spring.activemq.broker-url}")String url, RedeliveryPolicy redeliveryPolicy){
        ...
        properties.setProperty("prefetchPolicy.queuePrefetch","1");
     ...
     */
    @Bean
    public JmsListenerContainerFactory<?> jmsListenerContainer1(ConnectionFactory activeMQConnectionFactory) {
